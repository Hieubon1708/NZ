...
public class BlockUpgradeButton : ButtonState
{
    ...
    {
        if (blockUpgradeHandler.textMax.gameObject.activeSelf || PlayerController.instance.player.gold < DataManager.instance.blockConfig.priceUpgrades[blockUpgradeHandler.blockInfo.level]) return;
